...
![license](https://img.shields.io/badge/الرخصة-MIT-lightgrey?style=flat-square)
...
موزّع تحت رخصة **MIT** (انظر [LICENSE](LICENSE)) — حرٌّ للاستخدام التعليمي والتجاري مع الإسناد. أمثلة الكود توضيحية وتعليمية.
